...
public class _propostas implements ActionListener
{
    ...
    private void FormPanel ()
    {
        ...
        formPanel.add(_add.painlAdd_proposta, "p1");
        //formPanel.add(_edt.painlAdd_neg, "p2");
        formPanel.add(_rmv1.painlAdd_proposta, "p3");
    }
	...
	private void MainTable ()
	{
		...
		table.setBackground(new Color(0xfff3ef));
	...
	private void BuscarNegocio ()
	{
		try {
			...
			String sql1 = "SELECT negocio.idNegocio,negocio.designacaoNegocio,negocio.valorNegocio,empresa.nomeEmpresa,empresa.contactoEmpresa FROM proposta c INNER JOIN (negocio INNER JOIN empresa ON negocio.idEmpresa = empresa.idEmpresa) ON c.idNegocio = negocio.idNegocio;";
	...
	{	
		...
		mainPanel.setBackground(new Color(0xfff3ef));
