...
public class _oportunidades implements ActionListener
{
	...
	Rmv		_rmv;
	funcao		_rmv1;
	public _oportunidades (int roll)
	{
		MainPanel(roll);
	}
    ...
    private void FormPanel ()
    {
        ...
        formPanel.add(_add.painlAdd_oportunidade, "p1");
        //formPanel.add(_edt.painlAdd_neg, "p2");
        formPanel.add(_rmv1.painlAdd_oportunidade, "p3");
    }
	...
	private void BtnsOportunidades ()
	{
		...
		btns.setBackground(new Color(0xffffff));
	...
	private void MainTable ()
	{
		...
		table.setBackground(new Color(0xdceafd));
	...
	private void BuscarNegocio ()
	{
		try {
			...
			String sql1 = "SELECT negocio.idNegocio,negocio.designacaoNegocio,negocio.valorNegocio,empresa.nomeEmpresa,empresa.contactoEmpresa FROM concurso c INNER JOIN (negocio INNER JOIN empresa ON negocio.idEmpresa = empresa.idEmpresa) ON c.idNegocio = negocio.idNegocio;";
	...
	{	
		...
		mainPanel.setBackground(new Color(0xdceafd));
